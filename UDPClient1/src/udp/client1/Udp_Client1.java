...
public class Udp_Client1 extends javax.swing.JFrame {
    ...
    private static int ReceivePortAddress = 4002;
    private static int ReceivePortDownload = 4003;
        ...
        try {
            ...
            while (true) {
                ...
                if (type == 1) {
                    ...
                    //gui lenh "update fileshare" lai node vua edit danh sach file share
                    //nhan file "updatefileshare.txt" ve de cap nhat vao danh sach cua minh
                    try {
                        boolean check = false;
        ...
        for (int i = 0; i < node.size(); i++) {
            ...
            if (!(s1[0].equals(nodeName))) {
                ...
                try {
                    ...
                    // tao file
                    FileOutputStream fos = new FileOutputStream(new File(this.getFolderPathRoot() + "checknode.txt"));
                    //FileOutputStream fos = new FileOutputStream(new File("ping.txt"));
                    while (true) {
                        socketRecieve.setSoTimeout(1500);
                        try {
                            receiveData = new byte[1024];
