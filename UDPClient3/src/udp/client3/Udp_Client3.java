 ...
 */
public class Udp_Client3 extends javax.swing.JFrame {
    ...
    private static int ReceivePortAddress = 6002;
    private static int ReceivePortDownload = 6003;
    //ghi lai ten cua node    
    private static String nodeName = "Node3";
    //ghi lai duong dan tap tin va thu muc cua node
    private static String folderPathRoot = "../UDPClient3/";
    private static String folderPathShare = "../UDPClient3/Node3FileShare/";
    private static String folderPathDownload = "../UDPClient3/Node3Download/";
    private static String filePathShareHeThong = "../UDPClient3/node3_listfileshare.txt";
    private static String filePathNodeName = "../UDPClient3/nodes.txt";
    ...
    private static Udp_Client3 udp = new Udp_Client3();
    /**
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Udp_Client3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Logger.getLogger(Udp_Client3.class.getName()).log(Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    Logger.getLogger(Udp_Client3.class.getName()).log(Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    Logger.getLogger(Udp_Client3.class.getName()).log(Level.SEVERE, null, ex);
